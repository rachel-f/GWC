...
#def draw_square(length, ang, spd, clr):
#	for i in range(4): 
#		pencolor(clr)
#		forward(length)
#		right(ang)
...
#draw_square(leng, 90, 5, "blue")
#penup()
#forward(leng + 10)
#pendown()
#draw_square(leng, 90, 5, "green")
#penup()
#forward(leng + 10)
#pendown()
#draw_square(leng, 90, 5, "pink")


def draw_polygon(length, ang, spd, clr):
	for i in range(4): 
		pencolor(clr)
		forward(length)
		right(ang)
...
draw_polygon(leng, 90, 5, "blue")
penup()
forward(leng + 10)
pendown()

draw_polygon(leng, 90, 5, "green")
penup()
forward(leng + 10)
pendown()

draw_polygon(leng, 90, 5, "yellow",)
penup()
forward(leng + 10)
pendown()

draw_polygon(leng, 90, 5, "orange")
penup()
forward(leng + 10)
pendown()

draw_polygon(leng, 90, 5, "pink")
penup()
forward(leng + 10)
pendown()
...
def draw_triangle(length, ang, spd, clr):
	for i in range(3): 
		pencolor(clr)
		forward(length)
		left(ang)
...
draw_triangle(leng, 120, 5, "blue")
penup()
forward(leng + 10)
pendown()

draw_triangle(leng, 120, 5, "green")
penup()
forward(leng + 10)
pendown()

draw_triangle(leng, 120, 5, "yellow")
penup()
forward(leng + 10)
pendown()

draw_triangle(leng, 120, 5, "orange")
penup()
forward(leng + 10)
pendown()

draw_triangle(leng, 120, 5, "pink")
penup()
forward(leng + 10)
pendown()
